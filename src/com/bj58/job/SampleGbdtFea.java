...
public class SampleGbdtFea {
	...
	public static class SampleGbdtFeaMapper extends Mapper<Object, Text, Text, Text> {
		...
		// TODO:统计值范围
		// private EnumIntervalFeature sourceFea = new
		// EnumIntervalFeature("source", 0, 15);
		// private EnumIntervalFeature salaryFea = new
		// EnumIntervalFeature("salary", 0, 10);
		// private EnumIntervalFeature eduFea = new
		// EnumIntervalFeature("education", 0, 8);
		// private EnumIntervalFeature expFea = new
		// EnumIntervalFeature("experience", 0, 7);
		...
		// private EnumIntervalFeature tradeFea = new
		// EnumIntervalFeature("trade", 0,53);
		// 福利是多值，特殊处理
		...
		// private ContFeature localmatchFea = new ContFeature("localmatch", 0,
		// 1, 1);
		// private ContFeature catematchFea = new ContFeature("catematch", 0, 1,
		// 1);
		// private ContFeature salarymatchFea = new ContFeature("salarymatch",
		// 0, 1, 1);
		// private ContFeature edumatchFea = new ContFeature("educationmatch",
		// 0, 1, 1);
		// private ContFeature expmatchFea = new ContFeature("experiencematch",
		// 0, 1, 1);
		// private ContFeature entmatchFea = new ContFeature("enttypematch", 0,
		// 1, 1);
		// private ContFeature tradematchFea = new ContFeature("tradematch", 0,
		// 1, 1);
		// private ContFeature fulimatchFea = new ContFeature("fuliMatch", 0, 1,
		// 1);
