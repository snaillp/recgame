...
//		private EnumIntervalFeature expFea = new EnumIntervalFeature("experience", 0, 7);
		private ContFeature salaryFea = new ContFeature("salary", 0, 10, 1);
		private ContFeature eduFea = new ContFeature("education", 0, 8, 1);
		private ContFeature expFea = new ContFeature("experience", 0, 7, 1);
...
//		private EnumIntervalFeature tradeFea = new EnumIntervalFeature("trade", 0,53);
		...
		// TODO:统计值范围
		private ContFeature highlightFea = new ContFeature("highlights", 0, 15, 1);
		private EnumIntervalFeature additionFea = new EnumIntervalFeature("additional", 0, 4);
//		private ContFeature localmatchFea = new ContFeature("localmatch", 0, 4, 1);
//		private ContFeature catematchFea = new ContFeature("catematch", 0, 4, 1);
